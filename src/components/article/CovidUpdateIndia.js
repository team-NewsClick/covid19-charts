 ...
 */
const CovidUpdateIndia = ({covidSummary}) => {
          ...
          <div className="lg:flex lg:px-10 lg:pb-8">
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaTotalConfirmed)}
              </div>
            </div>
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaTotalDeaths)}
              </div>
            </div>
          </div>
          <div className="lg:flex lg:px-10 lg:pb-8">
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaTotalTests)}
              </div>
            </div>
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaTotalRecovery)}
              </div>
            </div>
          </div>
          <div className="lg:flex lg:px-10 lg:pb-8">
            ...
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaTotalVaccinated)}
              </div>
            </div>
          </div>
          <div className="lg:flex lg:px-10 lg:pb-8">
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {covidSummary.firstDoseAdministered}%
              </div>
            </div>
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              <div className="text-2xl font-bold text-green-900">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {covidSummary.secondDoseAdministered}%
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="lg:flex lg:px-10 lg:pb-8">
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaNewConfirmed)}
              </div>
            </div>
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              <div className="text-2xl font-bold text-pink-700">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaNewDeaths)}
              </div>
            </div>
          </div>
          <div className="lg:flex lg:px-10 lg:pb-8">
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaNewTests)}
              </div>
            </div>
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              <div className="text-2xl font-bold text-green-900">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaNewRecovery)}
              </div>
            </div>
          </div>
          <div className="lg:flex lg:px-10 lg:pb-8">
            <div className="md:flex lg:w-1/2 pb-8 lg:p-0 lg:pl-12">
              ...
              <div className="text-3xl md:text-2xl font-bold pt-2 md:p-0">
                {indPlaceVal(covidSummary.indiaNewVaccinated)}
              </div>
            </div>
          </div>
        </div>
